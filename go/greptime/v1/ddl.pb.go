...
func (AddColumn_Location_LocationType) EnumDescriptor() ([]byte, []int) {
	return file_greptime_v1_ddl_proto_rawDescGZIP(), []int{12, 0, 0}
}
...
type CreateTableExpr struct {
	...
	PartitionsDef     *PartitionsDef    `protobuf:"bytes,13,opt,name=partitions_def,json=partitionsDef,proto3" json:"partitions_def,omitempty"`
}
...
func (x *CreateTableExpr) GetPartitionsDef() *PartitionsDef {
	if x != nil {
		return x.PartitionsDef
	}
	return nil
}

type PartitionsDef struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ColumnNames   []string                      `protobuf:"bytes,1,rep,name=column_names,json=columnNames,proto3" json:"column_names,omitempty"`
	PartitionDefs []*PartitionsDef_PartitionDef `protobuf:"bytes,2,rep,name=partition_defs,json=partitionDefs,proto3" json:"partition_defs,omitempty"`
}

func (x *PartitionsDef) Reset() {
	*x = PartitionsDef{}
	if protoimpl.UnsafeEnabled {
...
func (x *PartitionsDef) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PartitionsDef) ProtoMessage() {}

func (x *PartitionsDef) ProtoReflect() protoreflect.Message {
	mi := &file_greptime_v1_ddl_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PartitionsDef.ProtoReflect.Descriptor instead.
func (*PartitionsDef) Descriptor() ([]byte, []int) {
	return file_greptime_v1_ddl_proto_rawDescGZIP(), []int{2}
}

func (x *PartitionsDef) GetColumnNames() []string {
	if x != nil {
...
func (x *PartitionsDef) GetPartitionDefs() []*PartitionsDef_PartitionDef {
	if x != nil {
		return x.PartitionDefs
	}
	return nil
}
...
type PartitionsDef_MaxValue struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
}

func (x *PartitionsDef_MaxValue) Reset() {
	*x = PartitionsDef_MaxValue{}
	if protoimpl.UnsafeEnabled {
...
func (x *PartitionsDef_MaxValue) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PartitionsDef_MaxValue) ProtoMessage() {}

func (x *PartitionsDef_MaxValue) ProtoReflect() protoreflect.Message {
	mi := &file_greptime_v1_ddl_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PartitionsDef_MaxValue.ProtoReflect.Descriptor instead.
func (*PartitionsDef_MaxValue) Descriptor() ([]byte, []int) {
	return file_greptime_v1_ddl_proto_rawDescGZIP(), []int{2, 0}
}

type PartitionsDef_ValueDef struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// Types that are assignable to RightBound:
	//
	//	*PartitionsDef_ValueDef_MaxValue
	//	*PartitionsDef_ValueDef_Value
	RightBound isPartitionsDef_ValueDef_RightBound `protobuf_oneof:"right_bound"`
}

func (x *PartitionsDef_ValueDef) Reset() {
	*x = PartitionsDef_ValueDef{}
	if protoimpl.UnsafeEnabled {
...
func (x *PartitionsDef_ValueDef) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PartitionsDef_ValueDef) ProtoMessage() {}

func (x *PartitionsDef_ValueDef) ProtoReflect() protoreflect.Message {
	mi := &file_greptime_v1_ddl_proto_msgTypes[17]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PartitionsDef_ValueDef.ProtoReflect.Descriptor instead.
func (*PartitionsDef_ValueDef) Descriptor() ([]byte, []int) {
	return file_greptime_v1_ddl_proto_rawDescGZIP(), []int{2, 1}
}

func (m *PartitionsDef_ValueDef) GetRightBound() isPartitionsDef_ValueDef_RightBound {
	if m != nil {
		return m.RightBound
	}
	return nil
...
func (x *PartitionsDef_ValueDef) GetMaxValue() *PartitionsDef_MaxValue {
	if x, ok := x.GetRightBound().(*PartitionsDef_ValueDef_MaxValue); ok {
		return x.MaxValue
	}
	return nil
}

func (x *PartitionsDef_ValueDef) GetValue() *Value {
	if x, ok := x.GetRightBound().(*PartitionsDef_ValueDef_Value); ok {
		return x.Value
	}
	return nil
}

type isPartitionsDef_ValueDef_RightBound interface {
	isPartitionsDef_ValueDef_RightBound()
}

type PartitionsDef_ValueDef_MaxValue struct {
	MaxValue *PartitionsDef_MaxValue `protobuf:"bytes,1,opt,name=max_value,json=maxValue,proto3,oneof"`
}

type PartitionsDef_ValueDef_Value struct {
	Value *Value `protobuf:"bytes,2,opt,name=value,proto3,oneof"`
}

func (*PartitionsDef_ValueDef_MaxValue) isPartitionsDef_ValueDef_RightBound() {}

func (*PartitionsDef_ValueDef_Value) isPartitionsDef_ValueDef_RightBound() {}

type PartitionsDef_PartitionDef struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Name      string                    `protobuf:"bytes,1,opt,name=name,proto3" json:"name,omitempty"`
	ValueDefs []*PartitionsDef_ValueDef `protobuf:"bytes,2,rep,name=value_defs,json=valueDefs,proto3" json:"value_defs,omitempty"`
}

func (x *PartitionsDef_PartitionDef) Reset() {
	*x = PartitionsDef_PartitionDef{}
	if protoimpl.UnsafeEnabled {
...
func (x *PartitionsDef_PartitionDef) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PartitionsDef_PartitionDef) ProtoMessage() {}

func (x *PartitionsDef_PartitionDef) ProtoReflect() protoreflect.Message {
	mi := &file_greptime_v1_ddl_proto_msgTypes[18]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PartitionsDef_PartitionDef.ProtoReflect.Descriptor instead.
func (*PartitionsDef_PartitionDef) Descriptor() ([]byte, []int) {
	return file_greptime_v1_ddl_proto_rawDescGZIP(), []int{2, 2}
}

func (x *PartitionsDef_PartitionDef) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *PartitionsDef_PartitionDef) GetValueDefs() []*PartitionsDef_ValueDef {
	if x != nil {
		return x.ValueDefs
	}
	return nil
...
var file_greptime_v1_ddl_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xdf, 0x03, 0x0a, 0x0a, 0x44, 0x64, 0x6c, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x4a, 0x0a, 0x0f, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x5f, 0x64,
	0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1f, 0x2e,
	0x67, 0x72, 0x65, 0x70, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x72, 0x65, 0x61,
	0x74, 0x65, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65, 0x45, 0x78, 0x70, 0x72, 0x48, 0x00,
	0x52, 0x0e, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x44, 0x61, 0x74, 0x61, 0x62, 0x61, 0x73, 0x65,
	0x12, 0x41, 0x0a, 0x0c, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x5f, 0x74, 0x61, 0x62, 0x6c, 0x65,
	...
	,
	...
	,
	...
	0x0b, 0x61, 0x64, 0x64, 0x5f, 0x63, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x73, 0x18, 0x04, 0x20, 0x01,
	...
	0x64, 0x64, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x73, 0x12, 0x3d, 0x0a, 0x0c, 0x64, 0x72, 0x6f,
	0x70, 0x5f, 0x63, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32,
	...
	,
	...
	0x49, 0x64, 0x52, 0x07, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x49, 0x64, 0x22, 0xe0, 0x01, 0x0a, 0x0e,
	0x46, 0x6c, 0x75, 0x73, 0x68, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x45, 0x78, 0x70, 0x72, 0x12, 0x21,
	...
	,
	...
	,
	...
	0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x49, 0x64, 0x52,
	0x07, 0x74, 0x61, 0x62, 0x6c, 0x65, 0x49, 0x64, 0x22, 0x45, 0x0a, 0x0a, 0x41, 0x64, 0x64, 0x43,
	...
	0xc8, 0x02, 0x0a, 0x09, 0x41, 0x64, 0x64, 0x43, 0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x12, 0x35, 0x0a,
	...
	0x6e, 0x44, 0x65, 0x66, 0x12, 0x15, 0x0a, 0x06, 0x69, 0x73, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x08, 0x52, 0x05, 0x69, 0x73, 0x4b, 0x65, 0x79, 0x12, 0x3b, 0x0a, 0x08, 0x6c,
	...
	0x6f, 0x6c, 0x75, 0x6d, 0x6e, 0x2e, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x08,
	0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0xaf, 0x01, 0x0a, 0x08, 0x4c, 0x6f, 0x63,
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x51, 0x0a, 0x0d, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f,
	0x6e, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x2c, 0x2e, 0x67,
	0x72, 0x65, 0x70, 0x74, 0x69, 0x6d, 0x65, 0x2e, 0x76, 0x31, 0x2e, 0x41, 0x64, 0x64, 0x43, 0x6f,
	0x6c, 0x75, 0x6d, 0x6e, 0x2e, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2e, 0x4c, 0x6f,
	...
	0x72, 0x5f, 0x63, 0x6c, 0x6f, 0x75, 0x6d, 0x6e, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x0f, 0x61, 0x66, 0x74, 0x65, 0x72, 0x43, 0x6c, 0x6f, 0x75, 0x6d, 0x6e,
	...
	0x09, 0x0a, 0x05, 0x41, 0x46, 0x54, 0x45, 0x52, 0x10, 0x01, 0x22, 0x20, 0x0a, 0x0a, 0x44, 0x72,
	...
	0x01, 0x28, 0x0d, 0x52, 0x02, 0x69, 0x64, 0x42, 0x4c, 0x0a, 0x0e, 0x69, 0x6f, 0x2e, 0x67, 0x72,
...
var file_greptime_v1_ddl_proto_goTypes = []interface{}{
	...
	(*PartitionsDef)(nil),                // 3: greptime.v1.PartitionsDef
	(*AlterExpr)(nil),                    // 4: greptime.v1.AlterExpr
	(*DropTableExpr)(nil),                // 5: greptime.v1.DropTableExpr
	(*FlushTableExpr)(nil),               // 6: greptime.v1.FlushTableExpr
	(*CompactTableExpr)(nil),             // 7: greptime.v1.CompactTableExpr
	...
	(*PartitionsDef_MaxValue)(nil),       // 17: greptime.v1.PartitionsDef.MaxValue
	(*PartitionsDef_ValueDef)(nil),       // 18: greptime.v1.PartitionsDef.ValueDef
	(*PartitionsDef_PartitionDef)(nil),   // 19: greptime.v1.PartitionsDef.PartitionDef
	(*AddColumn_Location)(nil),           // 20: greptime.v1.AddColumn.Location
	(*ColumnDef)(nil),                    // 21: greptime.v1.ColumnDef
	(*Value)(nil),                        // 22: greptime.v1.Value
}
var file_greptime_v1_ddl_proto_depIdxs = []int32{
	...
	4,  // 2: greptime.v1.DdlRequest.alter:type_name -> greptime.v1.AlterExpr
	5,  // 3: greptime.v1.DdlRequest.drop_table:type_name -> greptime.v1.DropTableExpr
	6,  // 4: greptime.v1.DdlRequest.flush_table:type_name -> greptime.v1.FlushTableExpr
	7,  // 5: greptime.v1.DdlRequest.compact_table:type_name -> greptime.v1.CompactTableExpr
	9,  // 6: greptime.v1.DdlRequest.truncate_table:type_name -> greptime.v1.TruncateTableExpr
	21, // 7: greptime.v1.CreateTableExpr.column_defs:type_name -> greptime.v1.ColumnDef
	16, // 8: greptime.v1.CreateTableExpr.table_options:type_name -> greptime.v1.CreateTableExpr.TableOptionsEntry
	15, // 9: greptime.v1.CreateTableExpr.table_id:type_name -> greptime.v1.TableId
	3,  // 10: greptime.v1.CreateTableExpr.partitions_def:type_name -> greptime.v1.PartitionsDef
	19, // 11: greptime.v1.PartitionsDef.partition_defs:type_name -> greptime.v1.PartitionsDef.PartitionDef
	10, // 12: greptime.v1.AlterExpr.add_columns:type_name -> greptime.v1.AddColumns
	11, // 13: greptime.v1.AlterExpr.drop_columns:type_name -> greptime.v1.DropColumns
	12, // 14: greptime.v1.AlterExpr.rename_table:type_name -> greptime.v1.RenameTable
	15, // 15: greptime.v1.AlterExpr.table_id:type_name -> greptime.v1.TableId
	15, // 16: greptime.v1.DropTableExpr.table_id:type_name -> greptime.v1.TableId
	15, // 17: greptime.v1.FlushTableExpr.table_id:type_name -> greptime.v1.TableId
	...
	21, // 21: greptime.v1.AddColumn.column_def:type_name -> greptime.v1.ColumnDef
	20, // 22: greptime.v1.AddColumn.location:type_name -> greptime.v1.AddColumn.Location
	17, // 23: greptime.v1.PartitionsDef.ValueDef.max_value:type_name -> greptime.v1.PartitionsDef.MaxValue
	22, // 24: greptime.v1.PartitionsDef.ValueDef.value:type_name -> greptime.v1.Value
	18, // 25: greptime.v1.PartitionsDef.PartitionDef.value_defs:type_name -> greptime.v1.PartitionsDef.ValueDef
	0,  // 26: greptime.v1.AddColumn.Location.location_type:type_name -> greptime.v1.AddColumn.Location.LocationType
...
func file_greptime_v1_ddl_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_greptime_v1_ddl_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PartitionsDef_MaxValue); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_greptime_v1_ddl_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PartitionsDef_ValueDef); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_greptime_v1_ddl_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PartitionsDef_PartitionDef); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_greptime_v1_ddl_proto_msgTypes[3].OneofWrappers = []interface{}{
	...
	file_greptime_v1_ddl_proto_msgTypes[17].OneofWrappers = []interface{}{
		(*PartitionsDef_ValueDef_MaxValue)(nil),
		(*PartitionsDef_ValueDef_Value)(nil),
	}
	type x struct{}
